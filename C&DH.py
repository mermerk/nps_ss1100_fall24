...
#### this function was adapted from suggestions generated by Chat GPT
...
def parse_command(input_string):
    """
    Parses an input command string and returns a tuple containing:
    - Full name of the subsystem or payload device
    - Text description of the command
    - Parameter value
    
    The input string is expected to follow this format:
    ...
    if len(parts) != 3:
        raise ValueError(f"Invalid input format. Expected 'Subsystem:Command:Parameter'. Got: {input_string}")
